...
parser.add_argument('-c','--config', action='store',type=argparse.FileType('r'),required = False, help='Specify config file. Default is %s' % src.configs.Config.defaultconfigfilename,dest='config',default=src.configs.Config.defaultconfigfilename)
